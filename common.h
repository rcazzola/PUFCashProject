...
// =========================
// Zero Trust
#define ZERO_TRUST_ENROLL_NUM_AUTHEN_TOKENS 10
...
#define ECT_NUM_BYTES 32 //NATASHA

// Size of of the TID that Alice sends to the Bank (through the TTP).
#define TID_NUM_BYTES (HASH_OUT_LEN_BYTES) 

// Setting the minimum withdrawal amount by Alice to $5.00
#define MIN_WITHDRAW_INCREMENT 500

// This is the number used in the rand function to bound Alice's withdrawal amounts. It represents the 
// number of 'MIN_WIDTHDRAW_INCREMENTS'. Cyrus and I discussed this and decided to upper bound withdrawals
// to (num_TTPs_to_select) * max bin size. This is 4 with the current number of 5 total TTPs and with a max
// bin size of 5000, this should be 20000 when multiplied by the min bin size/increment of 500. 
#define WITHDRAWAL_MAX_ALLOWED 40
